 ...
 const data = [
  ...
  console.log(data.map((i) => {return i.address.city}));

  // create an array of latitude and longitude coordinate pairs
  console.log(data.map((i) => {return i.address.geo}));

  // create an array of strings that combine the company's catchPhrase and bs
  console.log(data.map((i) => {return `${i.company.catchPhrase} ${i.company.bs}.`}));